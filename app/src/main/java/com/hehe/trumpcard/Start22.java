...
public class Start22 extends AppCompatActivity {
        ...
        if(requestCode==1&&resultCode==RESULT_OK){
            ...
            b2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(bmi >= 1.0 && bmi <= 18.4){
                        Intent intent = new Intent(Start22.this, Underweight.class);
                        startActivity(intent);
                    }
                    else if(bmi >= 18.5 && bmi <= 24.9){
                        Intent intent2 = new Intent(Start22.this, Normal.class);
                        startActivity(intent2);
                    }
                    else if(bmi >= 25.0 && bmi <= 50.0){
                        Intent intent3 = new Intent(Start22.this, Overweight.class);
